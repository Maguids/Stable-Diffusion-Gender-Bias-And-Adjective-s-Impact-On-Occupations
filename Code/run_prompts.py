...
# The main prompt to use (positive -> what i want to generate)
...
OUT_ROOT = Path(r"C:\Users\User\MIA\IAS\IAS-IA\Tests\Results")          # escolhe onde queres guardar o batch (Windows exemplo)
OUT_NAME = "nurse_successful"
...
def main() -> None:
    ...
    with requests.Session() as session:
        ...
        result = http_post_json(session, f"{WEBUI_BASE_URL}/sdapi/v1/txt2img", txt2img_payload, timeout=3600)

        # 8) Guardar metadados devolvidos pela API
